...
export default function Leaderboard({ users }) {
  ...
  const formatedUsers = userWithChallenges.sort((a, b) => {
      ...
      <Container>
        ...
        <section>
          <div className={`titulos ${mobile ? 'mobile' : ''}`}>
            ...
            {mobile && (
              <div>
                <span>Desafios e Experiência</span>
              </div>
            )}
            {!mobile && (
              <>
                ...
                <li key={user._id}>
                  ...
                  {!mobile && (
                    <>
                      <div className="info">
                        <p>
                          <b>{user.challengesCompleted || 0}</b> completados
                        </p>
                      </div>

                      <div className="info">
                        <p>
                          <b>{user.totalExperience || 0}</b> xp
                        </p>
                      </div>
                    </>
                  )}
