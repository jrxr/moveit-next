          ...
          <Container>
            ...
            <section className="grid">
              {user.achievements ? (
                  ...
                  <ul>
                    {user.achievements.map(badge => (
                      <li
                        key={badge.badge_id}
                        className="active"
                        onClick={() => defineBadge(badge)}
                      >
                        <img
                          src={`${process.env.NEXT_PUBLIC_NEXTAUTH_URL}${badge.image}`}
                ...
                <>
                  <h3>
                    Conquistas alcançadas <span>(0)</span>
                  </h3>
                  <p className="alert">
                    Você não alcançou nenhuma conquista até o momento.
                  </p>
                </>
              )}
            </section>
